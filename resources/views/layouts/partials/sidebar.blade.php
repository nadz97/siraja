    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="html/index.html" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="{{ asset('images/logo-kejari.png') }}" alt="logo">
                <img class="logo-dark logo-img" src="{{ asset('images/logo-kejari.png') }}" alt="logo-dark">
                <img class="logo-small logo-img logo-img-small" src="{{ asset('images/logo-kejari.png') }}"
                    alt="logo-small">
            </a>
        </div>
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    <li class="nk-menu-heading">
                        <h6 class="overline-title text-primary-alt">INSTANSI</h6>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="{{ URL('admin/instansi') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-bag"></em></span>
                            <span class="nk-menu-text">Instansi</span>
                        </a>
                    </li>
                    <li class="nk-menu-heading">
                        <h6 class="overline-title text-primary-alt">PEGAWAI</h6>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ URL('admin/roles') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-bag"></em></span>
                    ...
                    <li class="nk-menu-heading">
                        <h6 class="overline-title text-primary-alt">Penelitian</h6>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                    <a href="{{ route('penelitian.index') }}" class="nk-menu-link">
