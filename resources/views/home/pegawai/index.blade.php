                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Pegawai - Daftar Pegawai </h3>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            @can('pegawai-create')
                                                <li><a href="{{ route('pegawai.create') }}"
                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-tnx">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-lg"><span>Pegawai</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>instansi</span></div>
                                            
                                            <div class="nk-tb-col tb-col-lg"><span>Jabatan</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>Pangkat</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>Photo</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>Biodata</span></div>
                                        ...
                                        @foreach ($data as $key => $pgw)
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $pgw->usrName }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $pgw->insName }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $pgw->jabatan }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $pgw->pangkat }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <img  style="width: 40%; height: 40%;" src="{{ asset('images/' . $pgw->photo) }}" alt="">
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $pgw->biodata }} </span>
                                                </div>
                                                ...
                                                <div class="nk-tb-col nk-tb-col-status">
                                                    ...
                                                    <a class="Badge badge-sm badge-dim bg-outline-info d-none d-md-inline-flex"
                                                        href="{{ route('pegawai.show', $pgw->id) }}">Show</a>
                                                    <a class="Badge badge-sm badge-dim bg-outline-warning d-none d-md-inline-flex"
                                                        href="{{ route('pegawai.edit', $pgw->id) }}">Edit</a>
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['pegawai.destroy', $pgw->id], 'style' => 'display:inline']) !!}
