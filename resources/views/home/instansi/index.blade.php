                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Instansi - Daftar Instansi </h3>
                                <div class="nk-block-des text-soft">
                                    <p>You have total {{ $data->count() }} Instansi.</p>
                                </div>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            @can('instansi-create')
                                                <li><a href="{{ route('instansi.create') }}"
                                ...
                                <div class="card-inner">
                                    <div class="card-title-group">
                                        <div class="card-title">
                                            <h5 class="title">All Instansi</h5>
                                        </div>
                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-tnx">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-lg"><span>Nama instansi</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>Alamat</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>Logo</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span>No.Telephone</span></div>
                                        ...
                                        @foreach ($data as $key => $ins)
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $ins->nama }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $ins->alamat }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <img  style="width: 40%; height: 40%;" src="{{ asset('images/' . $ins->logo) }}" alt="">
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $ins->telp }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {{ $ins->email }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span class="tb-lead-sub"> {!! $ins->keterangan !!} </span>
                                                </div>
                                                ...
                                                <div class="nk-tb-col nk-tb-col-status">
                                                    ...
                                                    <a class="Badge badge-sm badge-dim bg-outline-warning d-none d-md-inline-flex"
                                                        href="{{ route('instansi.edit', $ins->id) }}">Edit</a>
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['instansi.destroy', $ins->id], 'style' => 'display:inline']) !!}
