                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-tnx">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-lg"><span>Nama</span></div>
                                        ...
                                        @foreach ($data as $key => $user)
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md">
                                                    <span class="tb-lead-sub"> {{ $user->name }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-md">
                                                    <span class="tb-lead-sub"> {{ $user->email }} </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    @if (!empty($user->getRoleNames()))
                                                        @foreach ($user->getRoleNames() as $v)
                                                            @if ($v !== 'Admin')
                                                                <label
                                                                    class="badge badge-sm badge-dim bg-outline-warning d-none d-md-inline-flex">{{ $v }}</label>
                                                            @else
                                                                <label
                                                                    class="badge badge-sm badge-dim bg-outline-success d-none d-md-inline-flex">{{ $v }}</label>
                                                            @endif
                                                        @endforeach
                                                    @endif
                                                </div>
